        ...
        <div className="row align-items-center">
          <div className="col-md-12 col-lg-6">
            <div className="img-with-bg">
              ...
              />
              <figure>
                <img className="img-fluid" src="assets/images/man.png" alt="" />
              </figure>
            </div>
          </div>
          <div className="col-md-12 col-lg-6">
              ...
              <div className="row">
                ...
                <div className="col-sm-12 col-lg-9">
                  ...
                  <div className="tab-content">
                    ...
                    >
                      <div className="genrl-block">
                        <h2>
                          Inspiring the Next Generation of Engineers Course
                        </h2>
                        <p>
                          Nullam suscipit id ante bibendum bibendum. Vivamus
                          interdum gravida justo id venenatis. tempus velit sed,
                          lobortis metus. Donec id tincidunt libero, eget
                          dapibus quam. Aenean felis ex, blandit pretium
                          pharetra eu.
                        </p>
                        <a href="about-us.html" className="butn1 butn-light">
                          More Detail
                        </a>
                      </div>
                    </div>
        ...
        <div className="row align-items-center">
          <div className="col-md-12 col-lg-6">
            <div className="courses-info genrl-block">
              ...
              <a href="#" className="butn with-bg get-login-register">
                Sign Up Now
              </a>
            </div>
          </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6">
                <div className="help-people genrl-block">
                  ...
                  <a href="courses.html" className="butn1 butn-bg">
                    Start Learning
                  </a>
                </div>
              </div>
                ...
                <blockquote>
                  <div className="quote-content">
                    <p>
                      ...
                      quod ii legunt. lectores legere me lius quod ii legunt.
                    </p>
                    <div>
                      <h3>
                        <a href="#">Jonathan Simpson</a>
                      </h3>
  ...
  <section>
    <div className="block no-bottom">
      <div className="container-fluid">
        ...
        <div className="gallery-car owl-carousel owl-theme">
          <div className="item">
