...
import Mandatatory_Discussion_img from "../img/slide2-02.jpg"

const Mandatatory_Discussion = () => {
  return (
    <div>
      <div className="container py-5">
        <div className="row d-flex justify-content-center">
            <div className="col-sm-12 col-md-10 col-lg-10">
                <h1 className='text-center'>Mandatatory Discussion</h1>
                ...
                <img src={Mandatatory_Discussion_img} alt="" />
            </div>
        </div>
      </div>
    </div>
...
export default Mandatatory_Discussion
